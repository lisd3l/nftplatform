<template>
  <div class="dashboard-editor-container">
    <div class="nav-tab">
      <div
        class="nav-tab-item"
        :class="tab == 'total' ? 'active' : ''"
        @click="tabChange('total')"
      >
      ...
      <div
        ...
        @click="tabChange('today')"
      >
        {{ $t("dashboard.todayStatistics") }}
      </div>
    </div>
    <div :class="tab == 'today' ? 'dis-no' : ''">
        ...
        <el-row class="row-bg" justify="space-between">
          <el-col :span="8">
            <div class="grid-content bg-purple-light">
              <div>{{ $t("dashboard.userDetails") }}</div>
              <div class="grid-text totalColor">
                {{ dasheBoardData.userCount }}
              </div>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="grid-content bg-purple-light">
              <div>{{ $t("dashboard.originalNumber") }}</div>
              <div class="grid-text originColor">
                {{
                  dasheBoardData.userCount - dasheBoardDataDay.oneDayUserCount
                }}
              </div>
            </div>
            <div class="grid-content bg-purple-light">
              <div>{{ $t("dashboard.dailyActiveNumber") }}</div>
              <div class="grid-text">
                {{ dasheBoardDataDay.userLoginAmount }}
              </div>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="grid-content bg-purple-light">
              <div>{{ $t("dashboard.additionalNumber") }}</div>
              <div class="grid-text addColor">
                {{ dasheBoardDataDay.oneDayUserCount }}
              </div>
            </div>
            <div class="grid-content bg-purple-light">
              <div>{{ $t("dashboard.dailyActivePersonTimes") }}</div>
              <div class="grid-text">
                {{ dasheBoardDataDay.userLoginCount }}
              </div>
            </div>
          </el-col>
        </el-row>
      ...
      <div class="data-box mt-30">
        ...
        <div class="box-text">
          {{ $t("dashboard.nftTotalNumber") }}:
          {{ dasheBoardData.nftCountTotal }}
        </div>
        <div class="box-progress">
          <div class="box-progress-left bg-orange">
            {{ $t("dashboard.nft1155Number") }}:
            {{ dasheBoardData.nftCount1155 }}
          </div>
          <div class="box-progress-right bg-pink">
            {{ $t("dashboard.nft721Number") }}: {{ dasheBoardData.nftCount721 }}
          </div>
        </div>
      ...
      <div class="data-box mt-30">
        ...
        <el-table :data="blindboxData" border style="width: 100%">
          <el-table-column
            align="center"
            prop="total"
            :label="$t('dashboard.totalNumber')"
          />
          <el-table-column
            align="center"
            prop="opened"
            :label="$t('dashboard.openedNumber')"
          />
        </el-table>
      </div>
    </div>
    <div :class="tab == 'total' ? 'dis-no' : ''">
      <!-- <div class="head-container">
        ...
        <el-icon v-else class="download"><Download /></el-icon>
      </div> -->
      <div class="data-box">
        ...
        <div class="box-info">
          <div class="box-info-right mr-70">
            ...
            <div class="box-item">
              <div class="box-item-title">
                {{ $t("dashboard.dailyActivePersonTimes") }}
              </div>
              <div class="box-item-text">
                {{ dasheBoardDataDay.userLoginCount }}
              </div>
            ...
            <div class="box-item">
              <div class="box-item-title">
                {{ $t("dashboard.blindboxOpened") }}
              </div>
              <div class="box-item-text">
                {{ dasheBoardDataDay.oneDayBlindBoxOpenCount }}
              </div>
            </div>
            <div class="box-item">
              <div class="box-item-title">
                {{ $t("dashboard.nftAddedNumber") }}
              </div>
              <div class="box-item-text">
                {{ dasheBoardDataDay.oneDayNftCountTotal }}
              </div>
            </div>
            <div class="box-item">
              <div class="box-item-title">
                {{ $t("dashboard.nftSaleNumber") }}
              </div>
              <div class="box-item-text">
                {{ dasheBoardDataDay.oneDayNftOnSaleCount }}
              </div>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      drawUserLine() {
        ...
        let original =
          this.dasheBoardData.userCount -
          this.dasheBoardDataDay.oneDayUserCount;
          ...
          series: [
            {
              ...
              data: [{ value: total, name: _this.$t("dashboard.totalUsers") }],
            },
            {
              name: "",
              type: "pie",
      ...
      drawNftLine() {
        ...
        myChart.setOption({
          ...
          xAxis: {
            data: [
              _this.$t("dashboard.sale"),
              _this.$t("dashboard.bid"),
              _this.$t("dashboard.auction"),
              _this.$t("dashboard.auctionBids"),
              _this.$t("dashboard.auctionAccept"),
            ],
          },
          yAxis: {},
          series: [
      ...
      drawToydayLine() {
        ...
        myChart.setOption({
          ...
          xAxis: {
            data: [
              _this.$t("dashboard.blindboxOpened"),
              _this.$t("dashboard.nftAddedNumber"),
              _this.$t("dashboard.nftSaleNumber"),
            ],
          },
          yAxis: {},
          series: [
