  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button
        class="filter-item"
        type="primary"
        v-permission="['POST /admin/blind/nft/add']"
        @click.prevent="handlerBtn('add')"
    ...
    >
      ...
      <el-table-column
        align="center"
        :label="$t('blind.nft.name')"
        prop="name"
      ></el-table-column>
      <el-table-column
        align="center"
        :label="$t('blind.nft.picture')"
      ...
      <el-table-column
        align="center"
        :label="$t('blind.nft.audioORvideo')"
        prop="metadataContent"
      >
        <template #default="scope">
          <media
      ...
      >
        <template #default="scope">
          <el-button
            type="danger"
            size="small"
            @click.prevent="handlerBtn('del', scope.row)"
            v-permission="['POST /admin/blind/nft/deleted']"
    ...
    >
        ...
        >
          ...
          <el-form-item :label="$t('blind.nft.picture')" prop="imgUrl">
            <upload-unit
              ...
              :refName="'blindboxNftImgRef'"
              :limitNum="1"
              :imageData="formData.imgUrl"
              :uploadStatus="dialogStatus == 'add'"
              @updateData="updateNftImg"
            ></upload-unit>
          </el-form-item>
          <el-form-item :label="$t('blind.nft.audioORvideo')" prop="animUrl">
            <upload-unit
              v-if="dialogFormVisible"
              :refName="'blindboxNftGifRef'"
              :limitNum="1"
              :imageData="formData.animUrl"
              :uploadStatus="dialogStatus == 'add'"
              @updateData="updateNftGif"
            ></upload-unit>
          </el-form-item>
          <el-form-item :label="$t('blind.nft.property')">
            <div
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button @click.prevent="handlerCancel">{{
            $t("blind.cancel")
          }}</el-button>
          <el-button
            :loading="apiLoading"
