  ...
  <div class="app-container">
    <div class="filter-container">
      <el-button
        ...
        v-permission="['POST /admin/blind/paytoken/add']"
    ...
    >
      ...
      <el-table-column
        ...
        :label="$t('blind.paytoken.picture')"
        align="center"
      >
        <template #default="scope">
          <media
            v-if="scope.row.metadataContent"
      ...
      >
        <template #default="scope">
          ...
          <el-button
            ...
            v-permission="['POST /admin/blind/paytoken/delete']"
