  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button
        ...
        v-permission="['POST /admin/blind/type/add']"
        ><el-icon><Plus /></el-icon>{{ $t("global.add") }}</el-button
      >
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column
        :label="$t('blind.type.name')"
        prop="name"
      ></el-table-column>
      <el-table-column
        :label="$t('global.contractAddress')"
        prop="address"
      ></el-table-column>
      <el-table-column
        align="center"
      ...
      >
        <template #default="scope">
          <el-button
            ...
            v-permission="['POST /admin/blind/type/edit']"
          ...
          <el-button
            ...
            v-permission="['POST /admin/blind/type/delete']"
          ...
          <el-form-item :label="$t('global.contractAddress')" prop="address">
            ...
            <div class="m-top-10">
              <el-button
                ...
                type="primary"
                @click="connect"
                >{{ $t("navbar.connectWallet") }}</el-button
              >
              <el-button
                size="small"
                v-else
      ...
      return {
        ...
        rules: {
          name: [
            {
              required: true,
              message: this.$t("blind.type.emptyName"),
              trigger: "blur",
            },
          ],
          address: [
            {
              required: true,
              message: this.$t("blind.type.emptyContractAddress"),
              trigger: "blur",
            },
          ],
        },
