...
public class FcAuctionController extends BaseController {
    ...
    public Object buyerFee(String token, String tokenId, String owner, String salt, Integer type) {
        if (StringUtils.isEmpty(tokenId) || StringUtils.isEmpty(owner) || StringUtils.isEmpty(salt) || null == type) {
