...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://192.168.1.111:3306/blindbox_fingernft?useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("blindbox_fingernft");
        dsc.setPassword("blindbox_fingernft");
